...
include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/c.rs"));
...
macro_rules! JS_OBJECT_INTERNAL_DEF {
  ($name: expr, $prop_flags: expr, $def_type: expr, $magic: expr, u: { prop_list: { $tab: expr, $len: expr } }) => {
    JSCFunctionListEntry {
      ...
      magic: $magic as i16,
      u: JSCFunctionListEntry__bindgen_ty_1 {
        prop_list: JSCFunctionListEntry__bindgen_ty_1__bindgen_ty_4 {
          tab: $tab,
          len: $len,
        },
      },
...
#[inline]
#[allow(non_snake_case)]
pub unsafe fn JS_PROP_STRING_DEF(
  name: *const c_char,
  cstr: *const c_char,
  prop_flags: u32,
) -> JSCFunctionListEntry {
...
#[inline]
#[allow(non_snake_case)]
pub unsafe fn JS_PROP_INT32_DEF(
  name: *const c_char,
  val: i32,
  prop_flags: u32,
) -> JSCFunctionListEntry {
...
#[inline]
#[allow(non_snake_case)]
pub unsafe fn JS_PROP_INT64_DEF(
  name: *const c_char,
  val: i64,
  prop_flags: u32,
) -> JSCFunctionListEntry {
...
#[inline]
#[allow(non_snake_case)]
pub unsafe fn JS_PROP_DOUBLE_DEF(
  name: *const c_char,
  val: f64,
  prop_flags: u32,
) -> JSCFunctionListEntry {
...
#[inline]
#[allow(non_snake_case)]
pub unsafe fn JS_ALIAS_BASE_DEF(
  name: *const c_char,
  from: *const c_char,
  base: i32,
) -> JSCFunctionListEntry {
...
pub struct JSResolveReject {
  pub resolve: JSValue,
  pub reject: JSValue,
}
unsafe impl Sync for JSResolveReject {}
unsafe impl Send for JSResolveReject {}
...
pub unsafe fn JS_NewPromise(ctx: *mut JSContext) -> JSPromise {
  let mut resolve_reject = MaybeUninit::<(JSValue, JSValue)>::uninit();
  let promise = JS_NewPromiseCapability(ctx, resolve_reject.as_mut_ptr() as _);
  let (resolve, reject) = resolve_reject.assume_init();
  JSPromise {
    resolve_reject: JSResolveReject { resolve, reject },
    promise,
  }
}
